...
<div class="row" id="sendgrid_contenedor">
  <div class="col-xs-12 col-sm-2">
  	<div class="well">
        <h5 class="green smaller lighter">Que es un email inv&aacute;lido?</h5>
        
        <p>Si un ISP informa o descubrimos con nuestro propio algoritmo que el correo electr&oacute;nico proporcionado no es v&aacute;lido, aparecer&aacute; en esta lista.</p>
		<p>Los correos electr&oacute;nicos inv&aacute;lidos SendGrid no los da de baja autom&aacute;ticamente como lo hace con los correos rechazados o los desinscritos.</p>
        <p>En la columna de la raz&oacute;n tendr&aacute; m&aacute;s detalle.</p>
    </div>
  </div>
