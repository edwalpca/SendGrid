...
<div class="row" id="sendgrid_contenedor">
  <div class="col-xs-12 col-sm-2">
  	<div class="well">
        <h5 class="green smaller lighter">Que es la lista de bloqueados?</h5>
        
        <p>Cuando su direcci&oacute;n IP ha sido agregada en una lista negra o ha sido bloqueado por una organizaci&oacute;n ISP, el correo eletr&oacute;nico afectado aparece en esta lista.</p>
		<p>Los correos electr&oacute;nicos bloqueados SendGrid no los da de baja autom&aacute;ticamente como lo hace con los correos rechazados o los desinscritos.</p>
		<p>En la columna de la raz&oacute;n tendr&aacute; m&aacute;s detalle sobre el motivo de bloqueo.</p>
        <p>Los correos electr&oacute;nicos bloqueados se borrar&aacute;n autom&aacute;ticamente despu&eacute;s de 30 d&iacute;as.</p>
    </div>
  </div>
