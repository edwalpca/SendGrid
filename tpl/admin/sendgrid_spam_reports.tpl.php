...
<div class="row" id="sendgrid_contenedor">
  <div class="col-xs-12 col-sm-2">
  	<div class="well">
        <h5 class="green smaller lighter">Que son los Reportados Spam?</h5>
        
        <p>Si una persona reporta el correo electr&oacute;nico como spam, se nos notifica por el ISP y lo agregamos a la lista.</p>
