...
if($_POST['consultar']=='si'){
	$response = file_get_contents("https://sendgrid.com/api/spamreports.get.json?api_user=".SENDGRID_API_USER."&api_key=".SENDGRID_API_KEY."&date=1&start_date=".$_POST['start_date']."&end_date".$_POST['end_date']."&email=".$_POST['email']);
	echo $response;
	exit;
}
